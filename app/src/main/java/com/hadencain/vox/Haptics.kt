...
object Haptics {
    // as? -- some OEM builds/configs can lack a VibratorManager; a hard cast would throw from
    // inside Pipeline.fail() as an unhandled coroutine exception. No-op on null instead.
